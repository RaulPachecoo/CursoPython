...
fondo = pygame.image.load("TankGame/images/fondo1.jpg")
fondo = pygame.transform.scale(fondo, (display_width, display_height))

fire_sound = pygame.mixer.Sound("TankGame/sounds/misil.wav")
explosion_sound = pygame.mixer.Sound("TankGame/sounds/explosión.wav")
...
def tank(x, y, turPos):
	...
	tank_image = pygame.image.load("TankGame/images/peru.png").convert_alpha()
...
def enemy_tank(x, y, turPos):
	...
	enemy_tank_image = pygame.image.load("TankGame/images/alemania.png").convert_alpha()
...
def game_over():
	...
	while game_over:
		...
		perdiste = pygame.image.load("TankGame/images/perdiste.png").convert_alpha()
...
def you_win():
	...
	while win:
		...
		gameDisplay.blit(fondo, (0, 0))
		ganaste = pygame.image.load("TankGame/images/ganaste.png").convert_alpha()
