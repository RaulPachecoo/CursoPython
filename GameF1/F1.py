...
carImg = pygame.image.load('GameF1/images/car.png')
carLeft = pygame.image.load('GameF1/images/car_left.png')
carRight = pygame.image.load('GameF1/images/car_right.png')
obstacle_Img = pygame.image.load('GameF1/images/obstacle.png')
...
texture = pygame.image.load('GameF1/images/texture.png')
texture = pygame.transform.scale(texture, (display_width, display_height))
background = pygame.image.load('GameF1/images/fondo.png')
background = pygame.transform.scale(background, (display_width, display_height))
backgroundRect = background.get_rect()

intro_1 = pygame.mixer.Sound('GameF1/sounds/intro1.wav')
intro_2 = pygame.mixer.Sound('GameF1/sounds/intro2.wav')
crash_sound = pygame.mixer.Sound('GameF1/sounds/car_crash.wav')
ignition = pygame.mixer.Sound('GameF1/sounds/ignition.wav')
pygame.mixer.music.load('GameF1/sounds/running.wav')
...
def high_score_update(dodged):
	hs = open('GameF1/resources/high_score.txt', 'w')
	temp = str(dodged)
	hs.write(temp)
...
def game_loop():
	...
	high_score_file = open('GameF1/resources/high_score.txt','r')
